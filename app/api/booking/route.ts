...
export async function POST(req: NextRequest) {
  try {
    ...
    // Best-effort, attendu pour la même raison que dans /api/activate_code
    // (fonction serverless) : ne fait jamais échouer la création, déjà
    // actée en base à ce stade.
    await sendBeneficiaryBookingEmail(supabase, booking.id, "booking_received")
