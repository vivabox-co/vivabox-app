...
type UIContextType = {
  ...
  // Permet de forcer l'affichage immédiat du RouteLoaderOverlay dès un clic
  // qui va déclencher un router.push, sans attendre que usePathname() ait
  // constaté le changement d'URL (voir RouteLoaderOverlay).
  navigating: boolean
